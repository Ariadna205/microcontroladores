...
# 1 "./monitoreo_sensores.h" 1
# 15 "./monitoreo_sensores.h"
void sensores_init(void);
int read_hall(void);
int read_movimiento(void);
# 2 "monitoreo_sensores.c" 2
...
void LCD_Clear(void);
# 7 "monitoreo_sensores.c" 2

# 1 "./KEYPAD.h" 1
# 52 "./KEYPAD.h"
void keypad_Init (void);
char keypad_getkey(void);
# 8 "monitoreo_sensores.c" 2
